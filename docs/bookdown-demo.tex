...
GP is widely used in the machine learning, computer experiments, and spatial statistics communities. There are ready-made R packages, such as \texttt{GpGp} and \texttt{deepgp}. It's also easy to use in Python. Chapter 5 (``Gaussian Process Regression'') of the book \emph{Surrogates} by \citet{gramacy2020surrogates} is a great resource if you are interested in learning more about Gaussian process!
