...
The book *An Introduction to Statistical Learning* by @james2013introduction is a great resource! This book provides a wealth of information about machine learning models; further, the authors do not assume that the readers are mainly interested in applying, rather than studying, ML models. The four premises offered by the authors, listed on pp 8-9 of the version about R, pointing to the practical focus of the book:
